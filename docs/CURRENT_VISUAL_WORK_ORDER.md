...
15. M01 anomaly B/C and D pixel compare → product asset promotion — B/C `PROJECT_ASSET_APPROVED / IMPLEMENTED`; D `PROJECT_ASSET_APPROVED / IMPLEMENTED / RUNTIME_RESOLVED / VISUAL_CORRECTION_REQUIRED` (Issue #278); remaining evidence and candidate promotion stay separate
