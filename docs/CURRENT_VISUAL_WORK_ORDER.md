...
27. M04 entrance consumer-resolution correction — repository wording corrected under Issue #305 before any runtime comparison; Notion follows after merge/readback. No product asset, Scene/catalog/runtime, UI, gameplay, save, or Human QA state changed.
```
