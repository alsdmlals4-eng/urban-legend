...
![괴이 매뉴얼 기록철 작업대 — 화면형 구현 후보](../visual/blueprint-reference-pack/2026-08-30/08-manual-deduction-dossier.png)
...
추리문, 오른쪽 2열 후보와 기록 보조를 동시에 비교한다. 후보의 색·크기·정렬은
정답이나 변형 여부를 알려주지 않으며, 이 화면은 사용자 시각 승인 전
