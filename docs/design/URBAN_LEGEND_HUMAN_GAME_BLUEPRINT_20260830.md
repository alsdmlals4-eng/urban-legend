...
### 매뉴얼 3열 작업대 · 실제 추리 화면의 기준

![괴이 매뉴얼 3열 작업대 — 화면형 구현 기준](../visual/blueprint-reference-pack/2026-08-30/07-manual-deduction-workbench.png)

*화면형 구현 기준: 실제 사건의 정답·단서·런타임 화면이 아니라, 플레이어가 출처가
