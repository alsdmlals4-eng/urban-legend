...
6. `docs/BENCHMARKING_REFERENCE_GUIDE.md` - 기획 판단이나 MVP 범위 판단이 필요한 경우
7. 현재 GitHub Issue 본문
8. `README.md`
9. 실제 수정 대상 JSON / GDScript / TSCN 파일
...
4. `docs/MVP_WORKFLOW_CHECKLIST.md` 확인
5. 현재 Issue 본문 확인
6. `README.md` 확인
7. `rg`로 관련 키워드 검색
8. 관련 JSON / GDScript / TSCN 직접 확인
