...
|---|---|
| 문서 버전 | v0.6 |
| 문서 상태 | MVP-040 기준 상세 통합 설계 + 폐주파수 방송국 vertical slice 구현 |
| 기준 게임 버전 | Ver 4.0 |
| 저장 스키마 | mvp-038 |
| 기준일 | 2026-07-14 |
...
### 현재 기준선: GDD v0.6 / MVP-040 + 세 번째 사건 vertical slice 구현

- 살아 있는 기획서와 DOCX 동기화 체계를 프로젝트 기준으로 고정한다.
- 현재 구현과 계획 콘텐츠의 경계를 문서에서 명확히 유지한다.
- 세 사건의 캠페인 계약을 유지하며, 발견·선택·회수·보고서 흐름을 수동 QA로 확인한다.

### 다음 단계

| 우선순위 | 목표 | 완료 기준 |
|---:|---|---|
| P0 | 세 사건 전체 캠페인 수동 QA | 폐주파수 발견·선택, 세 사건 보고서·DB, 저장 왕복, 10일 흐름 확인 |
