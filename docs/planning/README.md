...
| 작업 | 먼저 읽을 문서 | 검증 핵심 |
|---|---|---|
| CORE-MVP-001 조사·전투 PoC | 코어, 스트레스 보고서, GDD | 규칙 설명, 근거 배제, 전조 인과, 난수 공정성 |
| 사건 작성 | 코어, GDD, `urban-legend-investigation-case-authoring` | 전조·가설·지지·반박·미해결·위험 사례·포획 |
| UI 정보 위계 | GDD, 점진 공개 기획 | 전조·근거·대응 의도·직전 결과 우선 |
...
- 코어 변경은 `PROJECT_CORE.md`, 스트레스 보고서, GDD, 로드맵, 테스트를 함께 심사한다.
