...
| 파일 | 역할 |
|---|---|
| `docs/AI_SHARED_WORK_RULES.md` | 엔진·장르에 종속되지 않는 공용 AI 작업 원칙. 새 프로젝트에 먼저 복사하는 기준 문서. |
...
| 파일 | 역할 |
|---|---|
| `AGENTS.md` | 현재 프로젝트의 최상위 규칙. Godot 버전, 금지 범위, 프로젝트 특수 규칙을 둔다. |
| `docs/CODEX_SHARED_WORK_RULES.md` | 현재 프로젝트용 Codex 구현 규칙, Serena 사용 규칙, 보고 형식. |
...
단, `docs/DOCUMENTATION_MAP.md`의 프로젝트 전용 문서 목록은 새 프로젝트에 맞게 수정한다.
