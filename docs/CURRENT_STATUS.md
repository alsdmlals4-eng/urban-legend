...
| 현재 M04 timing 결정 | `D-2026-08-28-M04-ONE-DELAY-PREPARATION-VICTIM-RISK-TRADEOFF` + `D-2026-08-28-M04-ROUTE-MEMORY-ANCHOR-PREPARATION-BENEFIT` — 즉시 출동 또는 한 번 지연(+15 피해자 위험); 지연은 권나래의 능동형 귀가 기억 고정 공포 감소를 `-16 → -24`로 강화 |
