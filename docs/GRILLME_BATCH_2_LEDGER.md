...
- 업적·완전 달성을 원하는 플레이어만 준비를 바꿔 재도전하도록 설계
- 구현·사람 검증 미승인
...
- 축별 평가는 `미달 / 충족 / 우수 / 정밀`
- 실패·정상 종결 전 철수·기관 강제 봉쇄에는 종합 랭크 미부여
- 구현·사람 검증 미승인
...
- 일반 재도전은 `기록 재현`으로 숙련 기록만 갱신
- 피해자·관계·분기 환류·연도 결산의 캠페인 정본 유지
- 실제 서사 변경은 이후 진행을 폐기하는 별도 캠페인 되감기로만 허용
- 구현·사람 검증 미승인
...
- 조사 소단락·구출 시작·전투 시작에 주요 체크포인트 제공
- 선택·턴 단위 자유 되감기는 기본 미지원
- 결과 보고서에서 `결과 확정`해야 캠페인 정본 생성
- 확정 전 사건당 1회 `출동 재개` 허용
- 구현·사람 검증 미승인
