...
| 다음 작업 | P1 선택형 일상 에피소드 최소 세트 설계 |

현재 구현에는 최대 10일 캠페인, 오전·오후 순차 반일 운영, 조사 중 HQ 중단·재개, 요원 5능력, 괴이 안정화·회수, 사건 보고서·DB, 소문시장·마도회·퇴마사 계보와 3칸 의뢰 게시판이 포함된다.

MVP-041에서 텍스트 노벨 1차 기준을 활협전·화산의 딸·서울 2033·The Winter Tower로 재정립하고, 세 사건 전체 캠페인을 검증했다. 저승역 HQ 중단·재개, 빨간 우산과 세력 의뢰, 위험도 주입 없는 Day 8 폐주파수 발견, 첫 오대응 뒤 회수, 보고서·DB·저장·Day 10 마감이 통과했다. 게임 버전 `Ver 4.0`과 저장 스키마 `mvp-038`은 유지한다. 상세는 [`MVP041_THREE_CASE_CAMPAIGN_MANUAL_QA.md`](docs/qa/MVP041_THREE_CASE_CAMPAIGN_MANUAL_QA.md)를 따른다.
