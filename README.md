...
현재 버전은 `Ver 3.1`이며, MVP 번호를 소수점으로 반영합니다. 예를 들어 MVP-018은 `Ver 1.8`, MVP-022는 `Ver 2.2`, MVP-028은 `Ver 2.8`, MVP-030은 `Ver 3.0`, MVP-031은 `Ver 3.1`입니다.
...
- [ ] 메인 메뉴의 버전 표기가 현재 기준 `Ver 3.1`으로 표시된다.
