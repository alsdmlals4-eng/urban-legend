...
REQUIRED_BASE_SKILLS = {
    ...
    "establishing-project-core", "synchronizing-local-and-github-state",
    "maintaining-project-context-and-handoff", "governing-game-user-research-coverage",
    "designing-art-prompts-and-technique-cards", "pruning-stale-and-nonfunctional-material",
    "designing-vertical-slices", "diagnosing-game-engine-runtime-failures",
    "managing-base-change-proposals", "evolving-project-discipline-skills",
    "simplifying-skill-bodies", "managing-design-documents",
    "building-project-visual-dashboards", "running-adversarial-review-and-refinement",
    "managing-project-intake-and-work-contract", "maintaining-long-running-task-continuity",
...
REQUIRED_ADAPTER_ROLES = {
    ...
    "project_discipline_contract", "project_local_skill_root", "base_sync_audit",
    "operating_model", "project_agents", "base_version", "legacy_skill_aliases",
    "work_mode_and_skill_routing", "project_core", "game_design_source",
    "project_start_here", "project_context", "base_skill_coverage", "active_context",
    "roadmap", "design_document_registry_equivalent", "documentation_map",
    "base_skill_index", "validation_contract", "game_design_generator",
...
class BaseOperatingSyncTests(unittest.TestCase):
    ...
    def test_base_pin_has_one_human_authority_and_consistent_machine_sources(self) -> None:
        ...
        active_docs = [
            "START_HERE.md", "README.md", "docs/OPERATING_MODEL.md",
            "docs/WORK_MODE_AND_SKILL_ROUTING.md", "docs/CURRENT_STATUS.md",
            "docs/DOCUMENTATION_MAP.md", "docs/MVP_WORKFLOW_CHECKLIST.md",
        ]
    ...
    def test_path_adapter_and_untracked_docx_policy(self) -> None:
        ...
        self.assertEqual(pub["derivative_tracking"], "UNTRACKED_REGENERATE_ON_DEMAND")
        for field in ("source", "generator"):
            self.assertTrue((ROOT / pub[field]).exists())
        ignored = (ROOT / ".gitignore").read_text(encoding="utf-8")
        self.assertIn(pub["ignore_rule"], ignored)
        self.assertFalse((ROOT / pub["docx"]).exists(), "Generated DOCX must not be tracked in a clean tree")

    def test_project_disciplines_local_skill_and_aliases_are_preserved(self) -> None:
        ...
        local = self.registry.get("project_local_skills", [])
        self.assertEqual([x["skill_id"] for x in local], ["urban-legend-investigation-case-authoring"])
        self.assertTrue((ROOT / local[0]["path"]).is_file())
    ...
    def test_non_destructive_project_sources_remain(self) -> None:
        required = [
            "docs/planning/PROJECT_DIRECTION.md", "docs/planning/NARRATIVE_CONTENT_PLAN.md",
            "docs/planning/ART_PRESENTATION_PLAN.md", "docs/planning/PROGRESSIVE_DISCLOSURE_PLAN.md",
            "docs/GAME_DESIGN_DOCUMENT.md", "MVP_ROADMAP.md", "TEST_CHECKLIST.md",
        ]
        self.assertEqual([p for p in required if not (ROOT / p).is_file()], [])
