...
CURRENT_VISUAL_OWNERS = {
    "docs/CURRENT_VISUAL_ASSET_CONSUMER_CHECKLIST.md": "ten current approved entries",
    "docs/VISUAL_ANCHOR_SPEC.md": "10개 `PROJECT_ASSET_APPROVED` entry",
    "docs/CURRENT_VISUAL_WORK_ORDER.md": "10개 entry",
}
...
class CurrentVisualAssetAuthorityTests(unittest.TestCase):
    def test_current_visual_owners_enumerate_all_manifest_assets(self) -> None:
        ...
        self.assertEqual(10, len(re.findall(r'^\s*- asset_id:', manifest, flags=re.MULTILINE)))
        ...
        for relative_path, current_count_label in CURRENT_VISUAL_OWNERS.items():
            ...
            self.assertIn("CASE-04 Lume guide", text, relative_path)
