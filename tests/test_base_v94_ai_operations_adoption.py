...
class TestBaseV94Urban(unittest.TestCase):
 ...
 def test_views(self):
  ...
  p=json.loads((ROOT/'skills/PROJECT_PATH_ADAPTER.json').read_text(encoding='utf-8')); self.assertEqual('c987647d01ad2baa028a16e03d85ddfc1572a727',p['base']['commit']); self.assertEqual('3f2c4a624d302b704c1b5322eb5c9f34ad55abb9',p['base_release']['release_commit']); self.assertEqual(h,p['canonical_source_sha256'])
