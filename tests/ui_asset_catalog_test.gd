...
func _init() -> void:
	...
	assert(catalog.get_anomaly_cutout_id("episode_001_afterlife_station", 70) == "afterlife_d_cutout")
	assert(catalog.get_background_id("episode_001_afterlife_station", "investigation") == "afterlife_platform")
	assert(catalog.get_background_id("episode_002_red_umbrella_alley", "investigation") == "red_crossroads")
	...
	assert(catalog.get_texture("afterlife_d_cutout") != null)
	assert(catalog.get_texture("red_crossroads") != null)
