...
DeepSeek 읽기 전용 반대검토의 “일상 상태·기록은 사건 진행과 분리” 관찰은 채택했다. 반일 일정이나 경제를 일상에 추가하는 제안은 이 프로젝트의 일정 비소모 계약과 충돌하므로 제외했다. 상세 검증은 [`MVP042_DAILY_EPISODE_VALIDATION.md`](qa/MVP042_DAILY_EPISODE_VALIDATION.md)를 따른다.
...
| 두 사건 수동 검증 | 성공·실패 후 다섯 질문에 답할 수 있음 | 네 경로의 저장 왕복·보고서·DB와 두 해상도를 기록했다. 상세는 [`MVP039_MANUAL_UX_VALIDATION.md`](qa/MVP039_MANUAL_UX_VALIDATION.md)를 따른다. | 구현 확인 |
...
| 두 사건 자동·시각 QA | 구현 확인 | [`MVP039_MANUAL_UX_VALIDATION.md`](qa/MVP039_MANUAL_UX_VALIDATION.md)에 1280×720·1920×1080 검증 기록 |
| 두 사건 전체 캠페인 QA | 완료 기준 | [`TWO_CASE_CAMPAIGN_MANUAL_QA.md`](qa/TWO_CASE_CAMPAIGN_MANUAL_QA.md)에 3인·HQ 중단·저장·보고서·DB·의뢰·10일 검증 기록 |
| MVP-040 폐주파수 방송국 | 구현 확인 | [`MVP040_DEAD_FREQUENCY_SLICE.md`](qa/MVP040_DEAD_FREQUENCY_SLICE.md)의 발견 후 노출, 3단서·3회수 패턴·기존 타이밍 판정, 보고서·DB·저장·장면 경로 테스트 20/20 |
| MVP-041 세 사건 텍스트 노벨 캠페인 QA | 구현 확인 | [`MVP041_THREE_CASE_CAMPAIGN_MANUAL_QA.md`](qa/MVP041_THREE_CASE_CAMPAIGN_MANUAL_QA.md)의 Day 8 자연 발견, 세 사건 저장·보고서·DB, 오대응 학습, 10일 마감 테스트 136/136과 두 해상도 시각 QA |
| MVP-042 일정 비소모 일상 에피소드 3장 | 구현 확인 | [`MVP042_DAILY_EPISODE_VALIDATION.md`](qa/MVP042_DAILY_EPISODE_VALIDATION.md)의 카드 노출·저장 왕복·`mvp-038 → mvp-039` 이관·비소모 경계·두 해상도 UI QA |
| MVP-043 현장 UI·회수·5인·아트 | 구현 확인 | [`MVP043_UI_PROTAGONIST_VALIDATION.md`](qa/MVP043_UI_PROTAGONIST_VALIDATION.md)의 중앙 조사 진행, 팀 상태·아카 치환, 자동 전조 회수, 권나래 저장 이관, 초기 5인·외부 접점 4인, 캐릭터 아트 28종, 3×3 비저장·4×4 단일 저장 회귀 |
