...
description: Urban Legend의 프로덕션·PM 작업을 해당 본책, 등록 부록, 검증 경로로 라우팅한다.
---

# Urban Legend 프로덕션·PM 스킬

## 사용할 때

우선순위, Roadmap, Issue/PR, 위험, 인수와 완료 조건을 책임진다.

## 먼저 읽을 파일

1. `[기획서]/09_프로덕션_PM/09_프로덕션_PM_본책.md`
...
- PR #26은 대체 PR의 workflow 계약 대조 후에만 종료 후보가 된다.
