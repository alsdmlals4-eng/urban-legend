...
description: Urban Legend의 아트 작업을 해당 본책, 등록 부록, 검증 경로로 라우팅한다.
---
...
캐릭터·배경·UI 시각 언어, 승인 자산과 제작 상태를 책임진다.

## 먼저 읽을 파일

1. `[기획서]/06_아트/06_아트_본책.md`
...
- 자산 원본은 assets/에 두고 Asset Registry로 연결한다.
