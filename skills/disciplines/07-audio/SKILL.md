...
description: Urban Legend의 사운드 작업을 해당 본책, 등록 부록, 검증 경로로 라우팅한다.
---
...
BGM·SFX·음성 이벤트 연결과 믹싱 상태를 책임진다.

## 먼저 읽을 파일

1. `[기획서]/07_사운드/07_사운드_본책.md`
...
- 사운드 구현·QA 증거가 없으므로 다음 작업은 [미검증] 요구사항 확정이다.
