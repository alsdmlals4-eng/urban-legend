...
description: Urban Legend의 게임 디자인 작업을 해당 본책, 등록 부록, 검증 경로로 라우팅한다.
---

# Urban Legend 게임 디자인 스킬

## 사용할 때

조사·판단·선택·결과 루프, 미니게임, 캠페인 규칙과 수치를 책임진다.

## 먼저 읽을 파일

1. `[기획서]/02_게임_디자인/02_게임_디자인_본책.md`
